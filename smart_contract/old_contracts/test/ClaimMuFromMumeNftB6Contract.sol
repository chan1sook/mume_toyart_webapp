...
import "./MumeArtToyNftB6.sol";
import "./MuTokenB1.sol";
...
contract ClaimMuFromMumeNftB6Contract is AccessControl {
    ...
    function claimMu(uint256 tokenId) external {
        MumeArtToyNftB6 nftContract = MumeArtToyNftB6(mumeNftContract);
        MumeArtToyMuTokenB1 muContract = MumeArtToyMuTokenB1(muTokenContract);
