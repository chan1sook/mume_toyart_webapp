...
// Fixed from B3
// - Remove unnecessary files (Old version of contract)
// - Function Identity from B3
contract MumeArtToyNftB4 is ERC721, ERC721URIStorage, AccessControl {
    ...
    constructor()
        ERC721("MumeArtToyNft-Beta4", "MATN-B4")
    {
